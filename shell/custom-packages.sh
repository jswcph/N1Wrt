...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-homebox-zh-cn"
...
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-passwall-zh-cn sing-box"
...
#===========================以下imm仓库内的软件==============================↓
CUSTOM_PACKAGES="$CUSTOM_PACKAGES luci-i18n-uugamebooster-zh-cn"
